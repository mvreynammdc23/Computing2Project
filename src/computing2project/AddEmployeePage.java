...
public class AddEmployeePage extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AddEmployeePage.class.getName());
    ...
    private void initComponents() {
        ...
        AddNewEmployeeHeader.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 24)); // NOI18N
        AddNewEmployeeHeader.setForeground(new java.awt.Color(204, 0, 0));
        ...
        philhealthNumberField.setText("0000-0000-0000");
        ...
        tinField.setText("000-000-000-000");
        ...
        pagibigNumberField.setText("0000-0000-0000");
        ...
        phoneNumberField.setText("0900-000-0000");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(15, 15, 15)
                        .addComponent(AddNewEmployeeHeader))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(130, 130, 130)
    ...
    public static void main(String args[]) {
        ...
        //java.awt.EventQueue.invokeLater(() -> new AddEmployeePage().setVisible(true));
    }
